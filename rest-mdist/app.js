...
//
//
app.get("/mp4/:id", function(req, res) {
...
app.get("/mp4", function(req, res) {
    ...
    //<li><a href="/mp4list/${uniqID}">${infos}</a></li>
    var pre =  '<li><a href="/mp4list/';
    var middle = '">';
    var end = '</a></li>';
    var result = "";
    var uniqID = "";
        ...
        if (err) {
            ...
            data.Items.forEach(function(v) {
               ...
               // <li><a href="/mp4list/${uniqID}">${infos}</a></li>
                uniqID = v.uniqID.S;
                infos = v.infos.S;
                result += pre + uniqID + middle + infos + end;
...
//
//
app.get("/mp4list/:id", function(req, res) {
    ...
    const data = JSON.stringify({
     ...
     const request = http.request(options, (request) => {
    ...
    var uniqID = "";
    var video_end =  '</video>'
   + ' <p>  <input style="background-color: lightgreen; height: 50px; width: 150px" type="button" id="button2" onclick="playVI();" value="play"/>'
   + '<input style="background-color:#00CCFF; height: 50px; width: 150px" type="button" id="button1" onclick="pauseVI();" value="pause" />'
   +'';
...
//<button type="Button" style="background-color:#00CCFF; height: 50px; width: 100px">Big Button</button>
   ...
   // var docClient = new AWS.DynamoDB.DocumentClient({ region: 'us-east-1' })
    ...
    // var uuid_v = "da76c6ed-344a-4f6b-8533-cf862c635b24";
    // var seqNumber_v = 1;
    ...
    docClient.get(params, function(err, data) {
        if (err) {
            ...
            //uniqID = data.Item.uniqID;
            infos = data.Item.infos;
            let type = 'type="video/mp4">'
            let _src =  '<source src="https://s3.amazonaws.com/'   +   infos   + '" '  + type ;
